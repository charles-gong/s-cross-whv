...
public class CaptchaUtil {
    public static  class HttpResp{
        ...
        public double getCust_val() {
            return cust_val;
        }

        public void setCust_val(double cust_val) {
            this.cust_val = cust_val;
        }
        ...
        public void setRsp_data(String rsp_data) {
            this.rsp_data = rsp_data;
        }

        public String getPred_resl() {
            return pred_resl;
        }

        public void setPred_resl(String pred_resl) {
            this.pred_resl = pred_resl;
        }
    }
